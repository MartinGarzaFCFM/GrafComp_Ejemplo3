...
bool GraphicsClass::Initialize(OpenGLClass* OpenGL, HWND hwnd)
{
	...
	result = m_Model->Initialize(m_OpenGL, (char*)"data/cubo.tga", 0, true);
	if(!result)
	{
...
bool GraphicsClass::Render()
{
	...
	m_OpenGL->MatrixRotationY(worldMatrix, gira);
	...
	m_TextureShader->SetShaderParameters(m_OpenGL, worldMatrix, viewMatrix, projectionMatrix, 0, (int)vari3);
